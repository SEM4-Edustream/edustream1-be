...
public interface CourseRepository extends JpaRepository<Course, String> {
    ...
    // Category filtering
    org.springframework.data.domain.Page<Course> findByStatusAndCategorySlug(CourseStatus status, String categorySlug, org.springframework.data.domain.Pageable pageable);
    org.springframework.data.domain.Page<Course> findByStatusAndCategorySlugAndTitleContainingIgnoreCase(CourseStatus status, String categorySlug, String title, org.springframework.data.domain.Pageable pageable);
